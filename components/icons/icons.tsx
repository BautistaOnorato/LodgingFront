...
export const EyeIcon: React.FC<IconProps> = ({ classname, onClick }) => (
  <svg xmlns="http://www.w3.org/2000/svg" onClick={onClick} className={classname} viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
